...
path_address = 'C:\Users\Halcy\Dropbox\Nickel_Dithiolene_Research_Experimental_Data\Raw_Data_Analysis\Experimental_Result\Data_15_Experiment\Compiled_Data\';
...
while file_count <= length(files_list)
    ...
    Channel_2_mV(6500:7000) = smoothdata(Channel_2_mV(6500:7000),'gaussian',300);
