...
cycle_time = 4*3600+15*60; % total duration of a single experimental cycle, seconds
oxidation_duration = 45*60; % total duration of oxidative phase, seconds
...
reduction_start_time = 150*60+45*60; % time at which reduction starts, seconds
...
y_combined_2 = 350; % range limit of first graph subplot
y_decon_1 = 0; % range limit of second graph subplot
y_decon_2 = 150; % range limit of second graph subplot
