...
Propylene_Calibration_Conversion_slope = 7.70398857317038/(1e4); % mV-s per ppm
Propylene_Calibration_Conversion_b = 0;
Propane_Calibration_Conversion_slope = 6.07865554298353/(1e4); % mV-s per ppm
...
y_combined_2 = 100; % range limit of first graph subplot
...
export_file_address = "C:\Users\Halcy\Dropbox\Nickel_Dithiolene_Research_Experimental_Data\Data_Trends_Analysis\Deconvoluted_ECM_07.xls";
...
ECM_desorption_curve_fitting_range_before = 100; % range of ECM desorption time before reduction starts, seconds
