...
cycle_time = 4*3600-25*60; % total duration of a single experimental cycle, seconds
oxidation_duration = 5*60; % total duration of oxidative phase, seconds
...
reduction_start_time = 3*3600-25*60; % time at which reduction starts, seconds
...
Propylene_Calibration_Conversion_slope = 9.51534005535831/(1e5); % mV-s per ppm
...
Propane_Calibration_Conversion_b = 0.00423188895539256;
