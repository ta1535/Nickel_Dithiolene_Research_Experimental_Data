...
cycle_time = 4*3600-20*60; % total duration of a single experimental cycle, seconds
oxidation_duration = 10*60; % total duration of oxidative phase, seconds
...
reduction_start_time = 3*3600-20*60; % time at which reduction starts, seconds
...
Propylene_Calibration_Conversion_slope = 9.91534005535831/(1e5); % mV-s per ppm
Propylene_Calibration_Conversion_b = 0.000280742845195809;
Propane_Calibration_Conversion_slope = 5.72056903407609/(1e5); % mV-s per ppm
Propane_Calibration_Conversion_b = 0.003623188895539256;
...
y2_propane_propylene = 300; % range of first graph subplot
...
y_combined_2 = 300; % range limit of first graph subplot
