...
path_address = 'C:\Users\Halcy\Dropbox\Micro GC 990\Test_Series_419_March_29_2023_Toshi_MEA_Sample_S3\Compiled_Data\';
...
while file_count <= length(files_list)
    ...
    Channel_2_mV = smoothdata((GC_data_array_num(Number_Points+1:end)*(1e-5)),'gaussian',50); % Each data point's actual value is 10^5 smaller
...
[Channel_1_local_maxima_GC,Channel_1_maxima_index] = findpeaks(Channel_1_mV,'MinPeakWidth',0.1,'MinPeakProminence',0.001);
[Channel_2_local_maxima_GC,Channel_2_maxima_index] = findpeaks(Channel_2_mV,'MinPeakWidth',0.1,'MinPeakProminence',0.001);
