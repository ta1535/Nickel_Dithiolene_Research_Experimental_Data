...
Propylene_Calibration_Conversion_slope = 7.020323690014751/(1e4); % mV-s per ppm
Propylene_Calibration_Conversion_b = 0;
Propane_Calibration_Conversion_slope = 6.113411670949952/(1e4); % mV-s per ppm
...
export_file_address = "C:\Users\Halcy\Dropbox\Nickel_Dithiolene_Research_Experimental_Data\Data_Trends_Analysis\Deconvoluted_ECM_10.xls";
export_array = [fit_deconvoluted_ECM(:,1) fit_deconvoluted_ECM(:,4)];
