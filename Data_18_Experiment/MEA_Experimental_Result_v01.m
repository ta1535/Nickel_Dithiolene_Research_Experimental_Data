...
Propylene_Calibration_Conversion_slope = 7.32024154171543/(1e4); % mV-s per ppm
Propylene_Calibration_Conversion_b = 0;
Propane_Calibration_Conversion_slope = 6.75514589809882/(1e4); % mV-s per ppm
...
released_propylene_mole = [0 0 0 0];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
export_file_address = "D:\Dropbox\Nickel_Dithiolene_Research_Experimental_Data\Data_Trends_Analysis\Deconvoluted_ECM_18.xls";
