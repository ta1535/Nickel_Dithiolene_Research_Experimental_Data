...
CA_Data = table2array(readtable('CA_272_060_minutes_C01.txt','NumHeaderLines',1));
GC_Summary_Data = table2array(readtable('GC_Summary_Data.xls','NumHeaderLines',1));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Input following parameters
number_cycle = 1; % total number of experimental cycles
...
reduction_start_time = 3*3600+30*60; % time at which reduction starts, seconds
...
Propylene_Calibration_Conversion_slope = 8.07459425466205/(1e4); % mV-s per ppm
Propylene_Calibration_Conversion_b = 0;
Propane_Calibration_Conversion_slope = 8.45791765112007/(1e4); % mV-s per ppm
...
y2_propane_propylene = 150; % range of first graph subplot
...
y2_carbon = 1500; % range of third graph subplot
...
export_file_address = "D:\Dropbox\Nickel_Dithiolene_Research_Experimental_Data\Data_Trends_Analysis\Deconvoluted_ECM_34.xls";
export_array = [fit_deconvoluted_ECM(:,1) fit_deconvoluted_ECM(:,2)];
