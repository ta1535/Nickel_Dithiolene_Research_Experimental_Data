...
Propylene_Calibration_Conversion_slope = 7.17554045088105/(1e4); % mV-s per ppm
Propylene_Calibration_Conversion_b = 0;
Propane_Calibration_Conversion_slope = 4.22976092848937/(1e4); % mV-s per ppm
...
y2_propane_propylene = 1000; % range of first graph subplot
y1_water = 0; % range of second graph subplot
y2_water = 3e6; % range of second graph subplot
y1_carbon = 0; % range of third graph subplot
y2_carbon = 500; % range of third graph subplot
...
y_combined_2 = 150; % range limit of first graph subplot
y_decon_1 = 0; % range limit of second graph subplot
y_decon_2 = 60; % range limit of second graph subplot
